                    ...
                    <form method="POST" action="{{ route('register.store') }}" class="mt-8 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="username" value="{{ old('username') }}" placeholder="Masukkan Nama Pengguna; Contoh (Budi Herlambang)" required class="w-full rounded-xl border border-gray-200 bg-gray-50 py-3 pl-11 pr-4 text-sm text-gray-800 placeholder:text-gray-400 shadow-sm focus:border-red-500 focus:ring-2 focus:ring-red-500/30 focus:outline-none transition">
                            </div>
                            @error('username')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password" placeholder="Kata Sandi" required class="w-full rounded-xl border border-gray-200 bg-gray-50 py-3 pl-11 pr-4 text-sm text-gray-800 placeholder:text-gray-400 shadow-sm focus:border-red-500 focus:ring-2 focus:ring-red-500/30 focus:outline-none transition">
                            </div>
                            @error('password')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password_confirmation" placeholder="Konfirmasi Password" required class="w-full rounded-xl border border-gray-200 bg-gray-50 py-3 pl-11 pr-4 text-sm text-gray-800 placeholder:text-gray-400 shadow-sm focus:border-red-500 focus:ring-2 focus:ring-red-500/30 focus:outline-none transition">
                            </div>
                            @error('password')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
